...
declare module '@duffel/api' {
    ...
    import { BatchOfferRequests, OfferRequests, Offers, OrderCancellations, Orders, OrderChangeRequests, OrderChangeOffers, OrderChanges, Payments, PartialOfferRequests, SeatMaps, AirlineInitiatedChanges } from '@duffel/api/booking';
    ...
    import { hasService as hasServiceImport } from '@duffel/api/functions/hasService';
    import { hasAvailableSeatService as hasAvailableSeatServiceImport } from '@duffel/api/functions/hasAvailableSeatService';
    ...
    export const hasService: typeof hasServiceImport;
...
declare module '@duffel/api/booking' {
    ...
    export * from '@duffel/api/booking/Identity';
...
declare module '@duffel/api/Stays/Stays' {
    ...
    import { StaysSearchParams, StaysSearchResponse } from '@duffel/api/Stays/StaysTypes';
    import { Resource } from '@duffel/api/Resource';
    import { DuffelResponse } from '@duffel/api/types';
    import { Accommodation } from '@duffel/api/Stays/Accommodation';
    ...
    export class Stays extends Resource {
            ...
            /**
                ...
                */
            search: (params: StaysSearchParams) => Promise<DuffelResponse<StaysSearchResponse>>;
    }
}
...
declare module '@duffel/api/Payments/ThreeDSecureSessions' {
    export * from '@duffel/api/Payments/ThreeDSecureSessions/ThreeDSecureSessions';
}

declare module '@duffel/api/Identity/Identity' {
    import { Client } from '@duffel/api/Client';
    import { Resource } from '@duffel/api/Resource';
    import { CustomerUsers } from '@duffel/api/Identity/CustomerUsers';
    import { CustomerUserGroups } from '@duffel/api/Identity/CustomerUserGroups';
    import { ComponentClientKeys } from '@duffel/api/Identity/ComponentClientKeys';
    export class Identity extends Resource {
        ...
        customerUserGroups: CustomerUserGroups;
        componentClientKeys: ComponentClientKeys;
        constructor(client: Client);
    }
}

declare module '@duffel/api/functions/hasService' {
    import { Offer, SeatMap } from '@duffel/api/types';
    export function hasService(offer: Offer, seatMaps?: SeatMap[]): boolean;
}

declare module '@duffel/api/functions/hasAvailableSeatService' {
...
declare module '@duffel/api/booking/Identity' {
    export * from '@duffel/api/booking/Identity/ComponentClientKey';
}

declare module '@duffel/api/booking/BatchOfferRequests' {
    export * from '@duffel/api/booking/BatchOfferRequests/BatchOfferRequests';
}
...
declare module '@duffel/api/types' {
    ...
    export * from '@duffel/api/Identity/IdentityTypes';
}
...
declare module '@duffel/api/Stays/StaysTypes' {
    ...
    export interface StaysAmenity {
            type: 'parking' | 'gym' | 'wifi' | '24_hour_front_desk' | 'accessibility_hearing' | 'accessibility_mobility' | 'adult_only' | 'business_centre' | 'cash_machine' | 'childcare_service' | 'concierge' | 'laundry' | 'lounge' | 'pets_allowed' | 'pool' | 'restaurant' | 'room_service' | 'spa';
            description: string;
    }
...
declare module '@duffel/api/Stays/Accommodation' {
    export * from '@duffel/api/Stays/Accommodation/Accommodation';
}

declare module '@duffel/api/Stays/Brands' {
    export * from '@duffel/api/Stays/Brands/Brands';
}

declare module '@duffel/api/Stays/LoyaltyProgrammes' {
    export * from '@duffel/api/Stays/LoyaltyProgrammes/LoyaltyProgrammes';
}
...
declare module '@duffel/api/Payments/ThreeDSecureSessions/ThreeDSecureSessions' {
    import { Resource } from '@duffel/api/Resource';
    import { DuffelResponse } from '@duffel/api/types';
    interface Service {
            /**
    ...
    export class ThreeDSecureSessions extends Resource {
            ...
            /**
                ...
                */
            create: (data: ThreeDSecureSessionParameters) => Promise<DuffelResponse<ThreeDSecureSessionRecord>>;
    }
    export {};
}

declare module '@duffel/api/Identity/CustomerUsers' {
    import { Client } from '@duffel/api/Client';
    import { Resource } from '@duffel/api/Resource';
    import { DuffelResponse, PaginationMeta } from '@duffel/api/types';
    import { CustomerUser, CustomerUserPayload } from '@duffel/api/Identity/IdentityTypes';
    export class CustomerUsers extends Resource {
            ...
            /**
                ...
                */
            create: (data: CustomerUserPayload) => Promise<DuffelResponse<CustomerUser>>;
            /**
                * Retrieves an customer user by its ID
                */
            get: (id: CustomerUser["id"]) => Promise<DuffelResponse<CustomerUser>>;
            /**
                * Updates a customer user based on provided ID
                */
            update: (id: CustomerUser["id"], data: CustomerUserPayload) => Promise<DuffelResponse<CustomerUser>>;
            /**
                * Retrieves a list of customer user groups
                * Allows filtering by email
        
                */
            list: (options?: PaginationMeta & {
                    email?: string;
            }) => Promise<DuffelResponse<CustomerUser[]>>;
    }
}

declare module '@duffel/api/Identity/CustomerUserGroups' {
    import { Client } from '@duffel/api/Client';
    import { Resource } from '@duffel/api/Resource';
    import { DuffelResponse, PaginationMeta } from '@duffel/api/types';
    import { CustomerUserGroup, CustomerUserGroupPayload } from '@duffel/api/Identity/IdentityTypes';
    export class CustomerUserGroups extends Resource {
            ...
            /**
                * Retrieves a list of customer user groups
                */
            list: (options?: PaginationMeta) => Promise<DuffelResponse<CustomerUserGroup[]>>;
            /**
                * Creates a customer user group for the organisation.
                */
            create: (data: CustomerUserGroupPayload) => Promise<DuffelResponse<CustomerUserGroup>>;
            /**
                * Deletes a customer user group by its ID
                */
            delete: (id: CustomerUserGroup["id"]) => Promise<DuffelResponse<CustomerUserGroup>>;
            /**
                * Retrieves an customer user group by its ID
                */
            get: (id: CustomerUserGroup["id"]) => Promise<DuffelResponse<CustomerUserGroup>>;
            /**
                * Updates an customer user group by its ID
                */
            update: (id: CustomerUserGroup["id"], data: CustomerUserGroupPayload) => Promise<DuffelResponse<CustomerUserGroup>>;
    }
}

declare module '@duffel/api/Identity/ComponentClientKeys' {
    import { Client } from '@duffel/api/Client';
    import { Resource } from '@duffel/api/Resource';
    import { DuffelResponse } from '@duffel/api/types';
    import { ComponentClientKey, ComponentClientKeyPayload } from '@duffel/api/Identity/IdentityTypes';
    export class ComponentClientKeys extends Resource {
            ...
            /**
                ...
                */
            create: (data?: ComponentClientKeyPayload) => Promise<DuffelResponse<ComponentClientKey>>;
    }
}
...
declare module '@duffel/api/booking/Identity/ComponentClientKey' {
    export * from '@duffel/api/booking/Identity/ComponentClientKey/ComponentClientKeys';
}

declare module '@duffel/api/booking/BatchOfferRequests/BatchOfferRequests' {
    import { Client } from '@duffel/api/Client';
    import { Resource } from '@duffel/api/Resource';
    import { BatchOfferRequest, CreateBatchOfferRequest, CreateBatchOfferRequestResponse, CreateBatchOfferRequestQueryParameters, DuffelResponse } from '@duffel/api/types';
    /**
    ...
    export class BatchOfferRequests extends Resource {
            ...
            /**
                ...
                */
            get: (id: string) => Promise<DuffelResponse<BatchOfferRequest>>;
            /**
                * To search for flights, you'll need to create an `offer request`.
                ...
                */
            create: <QueryParams extends CreateBatchOfferRequestQueryParameters>(options: CreateBatchOfferRequest & QueryParams) => Promise<DuffelResponse<CreateBatchOfferRequestResponse>>;
    }
}
...
declare module '@duffel/api/booking/OrderChanges/OrderChanges' {
    import { Resource } from '@duffel/api/Resource';
    import { ConfirmOrderChangePayment, CreateOrderChangeParameters, DuffelResponse, OrderChangeOffer } from '@duffel/api/types';
    /**
    ...
    export class OrderChanges extends Resource {
            ...
            /**
                ...
                */
            create: (options: CreateOrderChangeParameters) => Promise<DuffelResponse<OrderChangeOffer>>;
            /**
            ...
            /**
                ...
                */
            confirm: (id: string, options: Partial<ConfirmOrderChangePayment>) => Promise<DuffelResponse<OrderChangeOffer>>;
    }
}
...
declare module '@duffel/api/booking/PartialOfferRequests/PartialOfferRequests' {
    ...
    import { CreatePartialOfferRequestQueryParam, SelectedPartialOffersParams } from '@duffel/api/booking/PartialOfferRequests/PartialOfferRequestTypes';
    /**
    ...
    export class PartialOfferRequests extends Resource {
            ...
            /**
                ...
                */
            create: <QueryParams extends CreatePartialOfferRequestQueryParam>(options: CreateOfferRequest & QueryParams) => Promise<DuffelResponse<OfferRequest>>;
            /**
...
declare module '@duffel/api/booking/BatchOfferRequests/BatchOfferRequestsTypes' {
    import { CabinClass, Offer } from '@duffel/api/types';
    import { CreateOfferRequestPassenger, CreateOfferRequestSlice, CreateOfferRequestPrivateFare } from '@duffel/api/booking/OfferRequests/OfferRequestsTypes';
...
declare module '@duffel/api/booking/OrderChangeOffers/OrderChangeOfferTypes' {
    import { OfferSliceSegment, OfferSliceSegmentPassengerBaggage } from '@duffel/api/booking/Offers/OfferTypes';
    import { PlaceType, Place, CabinClass } from '@duffel/api/types';
    /**
    ...
    export interface OrderChangeOfferSlice {
            ...
            /**
                * The segments - that is, specific flights - that the airline is offering to get the passengers from the `origin` to the `destination`
                */
            segments: Array<Pick<OfferSliceSegment, 'aircraft' | 'arriving_at' | 'departing_at' | 'destination' | 'destination_terminal' | 'distance' | 'duration' | 'id' | 'marketing_carrier' | 'marketing_carrier_flight_number' | 'operating_carrier' | 'operating_carrier_flight_number' | 'origin' | 'origin_terminal'> & {
                    /** Additional segment-specific information about the passengers included in the offer (e.g. their baggage allowance and the cabin class they will be travelling in) */
                    passengers: Array<{
                            baggages: OfferSliceSegmentPassengerBaggage[];
...
declare module '@duffel/api/booking/SeatMaps/SeatMapTypes' {
    ...
    export type SeatMapCabinRowSectionElementAmenity = Exclude<SeatMapCabinRowSectionElementType, 'empty' | 'seat' | 'restricted_seat_general'>;
}
...
declare module '@duffel/api/Identity/IdentityTypes' {
    ...
    export type ComponentClientKeyPayload = ComponentClientKeyPayloadNoData | ComponentClientKeyPayloadUserOnly | ComponentClientKeyPayloadUserAndOrderPayload | ComponentClientKeyPayloadUserAndBookingPayload;
    ...
    export interface ComponentClientKeyPayloadUserAndOrderPayload extends ComponentClientKeyPayloadUserOnly {
            /**
                * The ID of the order for which the client key will be created.
                */
            order_id: string;
    }
    export interface ComponentClientKeyPayloadUserAndBookingPayload extends ComponentClientKeyPayloadUserOnly {
            /**
...
declare module '@duffel/api/Stays/Accommodation/Accommodation' {
    import { Client } from '@duffel/api/Client';
    import { LocationParams, ListAccommodationParams, StaysAccommodationSuggestion, StaysAccommodation, StaysAccommodationReviewResponse } from '@duffel/api/Stays/StaysTypes';
    import { Resource } from '@duffel/api/Resource';
    import { DuffelResponse, PaginationMeta } from '@duffel/api/types';
    export class Accommodation extends Resource {
            ...
            reviews: (id: StaysAccommodation["id"], options?: PaginationMeta) => Promise<DuffelResponse<StaysAccommodationReviewResponse>>;
            /**
...
declare module '@duffel/api/Stays/Brands/Brands' {
    import { Client } from '@duffel/api/Client';
    import { StaysAccommodationBrand } from '@duffel/api/Stays/StaysTypes';
    import { Resource } from '@duffel/api/Resource';
    import { DuffelResponse } from '@duffel/api/types';
    export class Brands extends Resource {
            ...
            /**
                ...
                */
            get: (brandId: string) => Promise<DuffelResponse<StaysAccommodationBrand>>;
            /**
                * List brands
                */
            list: () => Promise<DuffelResponse<StaysAccommodationBrand[]>>;
    }
}

declare module '@duffel/api/Stays/LoyaltyProgrammes/LoyaltyProgrammes' {
    import { Client } from '@duffel/api/Client';
    import { StaysLoyaltyProgramme } from '@duffel/api/Stays/StaysTypes';
    import { Resource } from '@duffel/api/Resource';
    import { DuffelResponse } from '@duffel/api/types';
    export class LoyaltyProgrammes extends Resource {
            ...
            /**
                ...
                */
            list: () => Promise<DuffelResponse<StaysLoyaltyProgramme[]>>;
    }
}
...
declare module '@duffel/api/Stays/Bookings/Bookings' {
    ...
    export class Bookings extends Resource {
            ...
            /**
                ...
                */
            list: (options?: PaginationMeta) => Promise<DuffelResponse<StaysBooking[]>>;
            /**
                * Retrieves a generator of all bookings. The results may be returned in any order.
                * @link https://duffel.com/docs/api/bookings/list-bookings
                */
            listWithGenerator: () => AsyncGenerator<DuffelResponse<StaysBooking>, void, unknown>;
            /**
                * Cancel a booking
                * @param {string} bookingId - The ID of the booking
                */
            cancel: (bookingId: string) => Promise<DuffelResponse<StaysBooking>>;
    }
}
...
declare module '@duffel/api/Stays/Quotes/Quotes' {
    ...
    export class Quotes extends Resource {
            ...
            /**
                ...
                */
            get: (quoteId: string) => Promise<DuffelResponse<StaysQuote>>;
            /**
                * Create a quote for the selected rate
...
declare module '@duffel/api/booking/Identity/ComponentClientKey/ComponentClientKeys' {
    ...
    import { type ComponentClientKey } from '@duffel/api/booking/Identity/ComponentClientKey/types';
    /**
...
declare module '@duffel/api/booking/Identity/ComponentClientKey/types' {
    export interface ComponentClientKey {
        /**
