  ...
  const flightOffers = [
    {
      ...
      icon: "https://assets.duffel.com/img/airlines/for-light-background/full-color-logo/BA.svg",
      class: "Economy Basic",
      flight: "BA 1234",
      origin: "Heathrow",
      departure: "2020-06-13T16:38:02",
      destination: "John F. Kennedy International Airport",
      arrival: "2020-06-13T16:38:02",
      duration: "PT02H26M",
      total: "£45.00 GBP for adult",
    },
    {
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {flightOffers.map((offer) => {
              // Parse duration from ISO format (PT02H26M)
